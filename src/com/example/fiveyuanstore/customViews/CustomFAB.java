...
public class CustomFAB extends ImageButton {
	...
	private void init(AttributeSet attrSet) {
		...
		TypedArray arr = theme.obtainStyledAttributes(attrSet, com.example.fiveyuanstore.R.styleable.FAB, 0, 0);
		try {
			setBgColor(arr.getColor(R.styleable.FAB_bg_color, Color.TRANSPARENT));
			setBgColorPressed(arr.getColor(com.example.fiveyuanstore.R.styleable.FAB_bg_color_pressed, Color.GRAY));
	...
	/*public OnOrderHandlerClickListener listener;

	public interface OnOrderHandlerClickListener{
		public void orderHandlerClick();
	}
	public void setOrderHandlerClick(OnOrderHandlerClickListener listener){
